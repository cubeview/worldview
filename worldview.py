...
class WorldView:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('WorldView', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/WorldView/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Toggle world borders'),
            callback=self.run,
